        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1 space-y-6">
                ...
                <div class="bg-white dark:bg-zinc-900 rounded-xl shadow p-6 text-center">
                    <div class="relative inline-block">
                        ...
                        @if ($user->is_verified)
                            <span
                                class="absolute bottom-2 right-1 bg-green-500 text-white text-xs px-2 py-1 rounded-full border-2 border-white">
                                Verified
                            </span>
                        @endif
                    </div>
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div class="grid sm:grid-cols-3 gap-4">
                    <div
                        class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-6 rounded-xl shadow text-center">
                    ...
                    <div
                        class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-6 rounded-xl shadow text-center">
                    ...
                    <div
                        class="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950 dark:to-amber-900 p-6 rounded-xl shadow text-center">
