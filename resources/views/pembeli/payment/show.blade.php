...
<div class="max-w-6xl mx-auto p-4 space-y-6">
    ...
    {{-- Alert Messages --}}
    @if(session('error'))
        <div class="bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 p-4 rounded-lg border border-red-300 dark:border-red-700">
            {{ session('error') }}
        </div>
    @endif

    @if(session('success'))
        <div class="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 p-4 rounded-lg border border-green-300 dark:border-green-700">
            {{ session('success') }}
        </div>
    @endif
    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2 space-y-6">
            ...
            {{-- Order Items --}}
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-lg shadow">
                <h2 class="font-semibold text-gray-900 dark:text-white mb-4">Produk yang Dibeli ({{ $order->items->count() }})</h2>
                <div class="space-y-3">
