    ...
    public function createOrder(Order $order): array
    {
        try {
            ...
            $payload = [
                ...
                'destination_contact_name'  => $order->display_shipping_recipient_name ?? '',
                'destination_contact_phone' => $order->display_shipping_recipient_phone ?? '',
                'destination_address'       => $order->display_shipping_full_address ?? '',
                'destination_note'          => '',
                'destination_province_name' => $order->display_shipping_province_name ?? '',
                'destination_city_name'     => $order->display_shipping_city_name ?? '',
                'destination_postal_code'   => $order->display_shipping_postal_code ?? '',
